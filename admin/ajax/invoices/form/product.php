...
if( $id_invoice < 1 ) return;

$invoice_detail = $_POST;
$invoice_detail['product_name'] = addslashes($_POST['product_name']);

use Core\Controllers\Front\UserController;
$user = new UserController();
$invoice_detail['cby'] = $user->get('id');;

global $common;
$id_detail = $common->save('invoice_detail', $invoice_detail);
if( $id_detail ){
