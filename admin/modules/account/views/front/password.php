<div class="container" id="reset-password">
    <div class="row">
        <div class="col-sm-12 col-md-7">
            <h2 class="crimson-text font-italic"><?php trans_e("Forgot your password?", "account"); ?></h2>
            <strong><?php trans_e("Please enter the email address you used to register. We will then send you a new password.", "account"); ?></strong>
