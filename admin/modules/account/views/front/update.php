<div class="container" id="update">
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <form class="osForm" method="POST" action="<?=get_url('account/update');?>">

	        	<h1 class="mb-10"><?php trans_e("Edit profile", "account"); ?></h1>
				...
				<div class="form-group">
				    ...
				    <input value="" type="password" name="password" class="form-control" id="password" placeholder="<?php trans_e("Your Password...", "account"); ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				    <input name="update" type="submit" class="btn btn-large" value="<?php trans_e("Update", "account"); ?>">
				</div>
            </form>
        </div><!-- /.col-sm-6 -->
    </div><!-- /.row -->
