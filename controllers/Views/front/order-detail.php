<div class="container">
    ...
    <a class="button pull-left" href="<?= generate_url( 'account/history' ); ?>" title="<?php trans_e("Go to your order history page", "core"); ?>"><i class="fa fa-long-arrow-left"></i> <?php trans_e("View your order history", "core"); ?></a>
</div>